...
typedef enum WndResult {ERROR=-1, EXIT=0, VOID, DOSEARCH, SHOWLR, SHOWDB} wndresult_t;  //коды возврата функций, оперирующих окнами интерфейса; совместимы с ERR/OK, определёнными PDCurses
